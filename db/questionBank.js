export const menu = [
  ...
  // write a travel questionnaire to check if a user is qualified to travel to USA in this json format
  
  let quizContent = {
    USA: {
      route: "usa-travel-quiz",
      title: "USA Travel Quiz",
      description:
        "This questionaire helps determine wether you're ready to travel to the united states",
      result: 0,
      idx: 0,
      onPass: "this is the response if user passes the quiz",
      onFail: "this is the response if user fails the quiz",
      questions: [
        {
          question: "Do you have a passport?",
          answers: ["yes", "no", "not sure"],
          correctAnswer: "yes",
          responseIfWrongAnswer: "You need a passport to travel to USA",
        },
      ],
    },
  };
  
  // expand this into 10-15 questions in same Format and also generate a title with high click through potential and a route slug that fits this title and also creatively generate a 50 word description to go with the title